...
## Generated on : Sat Aug 28 10:30:42 2021
...
START_DIR                 = F:\STM32_Mode_Base\STM32F401_Model_Motor
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
SRCS = $(START_DIR)\Motor_Control_ert_rtw\Angle_Speed_100us.c $(START_DIR)\Motor_Control_ert_rtw\Control_Command_2ms.c $(START_DIR)\Motor_Control_ert_rtw\FOC_Control_100us.c $(START_DIR)\Motor_Control_ert_rtw\HF_Observer.c $(START_DIR)\Motor_Control_ert_rtw\Motor_Control.c $(START_DIR)\Motor_Control_ert_rtw\Motor_Control_data.c $(START_DIR)\Motor_Control_ert_rtw\Motor_State_10ms.c $(START_DIR)\Motor_Control_ert_rtw\Resolver_Angle_cacl.c $(START_DIR)\Motor_Control_ert_rtw\SpeedAndAngle.c $(START_DIR)\Motor_Control_ert_rtw\rtGetInf.c $(START_DIR)\Motor_Control_ert_rtw\rtGetNaN.c $(START_DIR)\Motor_Control_ert_rtw\rt_nonfinite.c $(START_DIR)\Motor_Control_ert_rtw\rt_sys_HF_Observer_37.c $(START_DIR)\Motor_Control_ert_rtw\rt_sys_HF_Observer_38.c $(START_DIR)\SMO_Function_wrapper.c
...
OBJS = Angle_Speed_100us.obj Control_Command_2ms.obj FOC_Control_100us.obj HF_Observer.obj Motor_Control.obj Motor_Control_data.obj Motor_State_10ms.obj Resolver_Angle_cacl.obj SpeedAndAngle.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sys_HF_Observer_37.obj rt_sys_HF_Observer_38.obj SMO_Function_wrapper.obj
...
HF_Observer.obj : $(START_DIR)\Motor_Control_ert_rtw\HF_Observer.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\Motor_Control_ert_rtw\HF_Observer.c
...
Motor_State_10ms.obj : $(START_DIR)\Motor_Control_ert_rtw\Motor_State_10ms.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\Motor_Control_ert_rtw\Motor_State_10ms.c
...
SpeedAndAngle.obj : $(START_DIR)\Motor_Control_ert_rtw\SpeedAndAngle.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\Motor_Control_ert_rtw\SpeedAndAngle.c
...
rt_sys_HF_Observer_37.obj : $(START_DIR)\Motor_Control_ert_rtw\rt_sys_HF_Observer_37.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\Motor_Control_ert_rtw\rt_sys_HF_Observer_37.c


rt_sys_HF_Observer_38.obj : $(START_DIR)\Motor_Control_ert_rtw\rt_sys_HF_Observer_38.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\Motor_Control_ert_rtw\rt_sys_HF_Observer_38.c


SMO_Function_wrapper.obj : $(START_DIR)\SMO_Function_wrapper.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\SMO_Function_wrapper.c
