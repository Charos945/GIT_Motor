...
typedef struct Hall_Parameter_tag {
  real32_T HaLL_AngleShift;            /* Referenced by:
                                        ...
                                        * '<S73>/Constant1'
                                        */
  real32_T HaLL_Sector6;               /* Referenced by: '<S68>/Constant' */
  real32_T HaLL_Sector4;               /* Referenced by: '<S69>/Pi//3' */
  real32_T HaLL_Sector5;               /* Referenced by: '<S70>/Constant' */
  real32_T HaLL_Sector1;               /* Referenced by: '<S71>/Constant' */
  real32_T HaLL_Sector3;               /* Referenced by: '<S72>/Constant' */
  real32_T HaLL_Sector2;               /* Referenced by: '<S73>/Constant' */
