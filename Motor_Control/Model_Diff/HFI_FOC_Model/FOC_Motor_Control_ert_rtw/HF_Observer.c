...
void HFI_State_machine(void)
{
   ...
   */
  if (rtDW.is_active_c7_FOC_Motor_Control == 0U) {
    rtDW.is_active_c7_FOC_Motor_Control = 1U;
    rtDW.is_c7_FOC_Motor_Control = IN_HFI_IPD;
    rtDW.temporalCounter_i1_m = 0U;
    rtDW.HFI_state = 1U;
    rtDW.IPD_flag = 1.0;
  } else {
    switch (rtDW.is_c7_FOC_Motor_Control) {
     case IN_HFI_IPD:
      rtDW.HFI_state = 1U;
      if ((rtDW.temporalCounter_i1_m >= (uint32_T)ceil
        ...
        rtDW.is_c7_FOC_Motor_Control = IN_HFI_NS;
        rtDW.temporalCounter_i1_m = 0U;
        rtDW.HFI_state = 2U;
        rtDW.NS_flag = 1.0;
      }
     ...
     case IN_HFI_NS:
      ...
      if ((rtDW.temporalCounter_i1_m >= (uint32_T)ceil(HFI_Parameter.HFI_NS_Time
        ...
        rtDW.is_c7_FOC_Motor_Control = IN_HFI_RUN;
        rtDW.HFI_state = 3U;
      }
      break;
...
void NS_State_machine(void)
{
   ...
   */
  if (rtDW.is_active_c8_FOC_Motor_Control == 0U) {
    rtDW.is_active_c8_FOC_Motor_Control = 1U;
    rtDW.is_c8_FOC_Motor_Control = IN_NS_1;
    rtDW.temporalCounter_i1_a = 0U;
    rtDW.NS_state = 1U;
    rtDW.NS_1_flag = 1.0;
  } else {
    switch (rtDW.is_c8_FOC_Motor_Control) {
     case IN_NS_1:
      rtDW.NS_state = 1U;
      if ((rtDW.temporalCounter_i1_a >= (uint32_T)ceil
           (HFI_Parameter.HFI_NS_Low_Time / 0.0001 - 1.0E-12)) &&
          (rtDW.NS_1_flag == 1.0)) {
        rtDW.is_c8_FOC_Motor_Control = IN_NS_2;
        rtDW.temporalCounter_i1_a = 0U;
        rtDW.NS_state = 2U;
        rtDW.NS_2_flag = 1.0;
      }
     ...
     case IN_NS_2:
      ...
      if ((rtDW.temporalCounter_i1_a >= (uint32_T)ceil
           ...
           == 1.0)) {
        rtDW.is_c8_FOC_Motor_Control = IN_NS_3;
        rtDW.temporalCounter_i1_a = 0U;
        rtDW.NS_state = 3U;
        rtDW.NS_3_flag = 1.0;
      }
     ...
     case IN_NS_3:
      ...
      if ((rtDW.temporalCounter_i1_a >= (uint32_T)ceil
           (HFI_Parameter.HFI_NS_Low_Time / 0.0001 - 1.0E-12)) &&
          (rtDW.NS_3_flag == 1.0)) {
        rtDW.is_c8_FOC_Motor_Control = IN_NS_4;
        rtDW.temporalCounter_i1_a = 0U;
        rtDW.NS_state = 4U;
        rtDW.NS_4_flag = 1.0;
      }
     ...
     case IN_NS_4:
      ...
      if ((rtDW.temporalCounter_i1_a >= (uint32_T)ceil
           ...
           == 1.0)) {
        rtDW.is_c8_FOC_Motor_Control = IN_NS_5;
        rtDW.NS_state = 5U;
      }
      break;
...
void StartRUN_State_machine(void)
{
   ...
   *  Constant: '<S58>/Const5'
   */
  if (rtDW.is_active_c6_FOC_Motor_Control == 0U) {
    rtDW.is_active_c6_FOC_Motor_Control = 1U;
    rtDW.is_c6_FOC_Motor_Control = IN_NS_2_RUN;
    rtDW.temporalCounter_i1 = 0U;
    rtDW.RUN_state = 1U;
    rtDW.NS_RUN_flag = 1.0;
  } else {
    switch (rtDW.is_c6_FOC_Motor_Control) {
     case IN_NS_2_RUN:
      rtDW.RUN_state = 1U;
      if ((rtDW.temporalCounter_i1 >= (uint32_T)ceil
           (HFI_Parameter.HFI_NS2RUN_Time / 0.0001 - 1.0E-12)) &&
          (rtDW.NS_RUN_flag == 1.0)) {
        rtDW.is_c6_FOC_Motor_Control = IN_Start_RUN;
        rtDW.temporalCounter_i1 = 0U;
        rtDW.RUN_state = 2U;
     ...
     default:
      ...
      if ((rtDW.temporalCounter_i1 >= (uint32_T)ceil
          ...
          (rtDW.Switch_flag == 1.0)) {
        rtDW.is_c6_FOC_Motor_Control = IN_RUN;
        rtDW.RUN_state = 3U;
      }
      break;
    }
