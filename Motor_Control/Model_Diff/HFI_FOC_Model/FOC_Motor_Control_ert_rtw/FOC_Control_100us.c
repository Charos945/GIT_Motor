...
void Angle_set(void)
{
  ...
  if (HFI_Parameter.HFI_Fuc_Enalbe == 1) {
     ...
     */
    rtDW.Merge1_k = rtDW.Direct_Angle;
...
void SVPWM(void)
{
   ...
   *  Switch: '<S179>/Switch2'
   */
  rtb_Saturation = (real32_T)((((rtb_IndexVector1 - rtDW.Merge1 >= 0.0F) << 1) +
    (rtDW.Merge1 >= 0.0F)) + (((0.0F - rtDW.Merge1) - rtb_IndexVector1 >= 0.0F) <<
    2));
  ...
  switch ((int32_T)rtb_Saturation) {
   case 1:
    /* Outputs for Atomic SubSystem: '<S44>/XYZ Caculate' */
    rtb_IndexVector_c = (rtb_IndexVector1 - rtDW.Merge1) * -0.5F * rtb_Add1_fq;
     ...
     *  Sum: '<S182>/Add2'
     */
    rtb_Gain_a = ((0.0F - rtDW.Merge1) - rtb_IndexVector1) * -0.5F * rtb_Add1_fq;
   ...
   case 2:
    /* Outputs for Atomic SubSystem: '<S44>/XYZ Caculate' */
    rtb_IndexVector_c = ((0.0F - rtDW.Merge1) - rtb_IndexVector1) * -0.5F *
      rtb_Add1_fq;
     ...
     *  Sum: '<S182>/Add2'
     */
    rtb_Gain_a = -(rtDW.Merge1 * rtb_Add1_fq);
   ...
   case 4:
    /* Outputs for Atomic SubSystem: '<S44>/XYZ Caculate' */
    rtb_IndexVector_c = -(rtDW.Merge1 * rtb_Add1_fq);
     ...
     *  Sum: '<S182>/Add1'
     */
    rtb_Gain_a = (rtb_IndexVector1 - rtDW.Merge1) * -0.5F * rtb_Add1_fq;
   ...
   case 5:
     ...
     *  Sum: '<S182>/Add2'
     */
    rtb_Gain_a = -(((0.0F - rtDW.Merge1) - rtb_IndexVector1) * -0.5F *
                   rtb_Add1_fq);
