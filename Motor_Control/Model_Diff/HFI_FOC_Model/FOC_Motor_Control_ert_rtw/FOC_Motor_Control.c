...
static void rate_scheduler(void)
{
  ...
  if ((rtM->Timing.TaskCounters.TID[1]) > 3) {/* Sample time: [0.0001s, 0.0s] */
    rtM->Timing.TaskCounters.TID[1] = 0;
  }

  (rtM->Timing.TaskCounters.TID[2])++;
  if ((rtM->Timing.TaskCounters.TID[2]) > 79) {/* Sample time: [0.002s, 0.0s] */
    rtM->Timing.TaskCounters.TID[2] = 0;
  }

  (rtM->Timing.TaskCounters.TID[3])++;
  if ((rtM->Timing.TaskCounters.TID[3]) > 399) {/* Sample time: [0.01s, 0.0s] */
