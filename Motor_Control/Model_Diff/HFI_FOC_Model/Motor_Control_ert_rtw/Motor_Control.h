...
typedef struct {
  ...
  real32_T Merge1;                     /* '<S36>/Merge1' */
  real32_T Merge_g;                    /* '<S47>/Merge' */
  real32_T Merge1_i;                   /* '<S47>/Merge1' */
  ...
  uint8_T is_active_c6_Motor_Control;  /* '<S58>/StartRUN_State_machine' */
  uint8_T is_c6_Motor_Control;         /* '<S58>/StartRUN_State_machine' */
  uint8_T is_active_c8_Motor_Control;  /* '<S61>/NS_State_machine' */
  uint8_T is_c8_Motor_Control;         /* '<S61>/NS_State_machine' */
  uint8_T is_active_c7_Motor_Control;  /* '<S57>/HFI_State_machine' */
  uint8_T is_c7_Motor_Control;         /* '<S57>/HFI_State_machine' */
