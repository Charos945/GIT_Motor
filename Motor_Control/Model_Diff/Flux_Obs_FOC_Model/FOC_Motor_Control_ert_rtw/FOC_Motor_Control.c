...
real32_T Motor_Power;                  /* '<S207>/Add1' */
real32_T Motor_Torque;                 /* '<S208>/Add1' */
real32_T Hall_Angle;                   /* '<S74>/Merge1' */
real32_T Hall_Speed;                   /* '<S66>/Add1' */
real32_T Id_ref;                       /* '<S81>/Merge' */
real32_T Iq_ref;                       /* '<S81>/Merge1' */
real32_T Vq_voltage;                   /* '<S198>/Switch2' */
real32_T Id_measured;                  /* '<S103>/Add1' */
real32_T Iq_measured;                  /* '<S103>/Add2' */
real32_T V_alpha;                      /* '<S101>/Add' */
real32_T V_beta;                       /* '<S101>/Add3' */
real32_T ObserverOmega;                /* '<S181>/Saturation' */
real32_T Vd_voltage;                   /* '<S132>/Switch2' */
real32_T Ialpha;                       /* '<S107>/Gain2' */
real32_T Ibeta;                        /* '<S107>/Gain5' */
...
static void rate_scheduler(void)
{
  ...
  if ((rtM->Timing.TaskCounters.TID[2]) > 199) {/* Sample time: [0.002s, 0.0s] */
    rtM->Timing.TaskCounters.TID[2] = 0;
  }

  (rtM->Timing.TaskCounters.TID[3])++;
  if ((rtM->Timing.TaskCounters.TID[3]) > 999) {/* Sample time: [0.01s, 0.0s] */
    rtM->Timing.TaskCounters.TID[3] = 0;
  }
}

/* Model step function */
void FOC_Motor_Control_step(void)
{
  ...
  if (rtM->Timing.TaskCounters.TID[1] == 0) {
    ...
    rtDW.UnitDelay6_DSTATE = rtDW.Add1_n;
...
void FOC_Motor_Control_initialize(void)
{
  /* Registration code */
